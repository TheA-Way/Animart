    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-anime-dark border-b border-anime-accent/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link 
            to="/cart" 
            className="relative flex items-center gap-2 bg-anime-accent hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-all duration-200 font-bold"
          >
            🛒 Cart
            {/* Only show the count badge if there are items in the cart */}
            {cartItemCount > 0 && (
